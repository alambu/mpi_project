									  ...
									  $nr=1;foreach($row as $r): ?>
                                          <tr>
                                            ...
                                            <td>
											  ...
											  <td><a href="admin/student_bill_collection/<?php echo $r->id ?>"  target='_blank' class="btn btn-primary"><i class="fa fa-sort-amount-asc ">Collection</i></a></td>
											  ...
											  -->
											   ...
											   <td><a href="admin/bill_collection_reports/<?php echo $r->roll_no ?>/<?php echo $r->name?>" target='_blank' class="btn btn-primary"><i class="fa fa-sort-amount-asc ">View</i></a></td>
											   
											    <td><a href="admin/bill_collection_reports/<?php echo $r->roll_no ?>/<?php echo $r->name?>" target='_blank' class="btn btn-primary"><i class="fa fa-sort-amount-asc ">Voucher</i></a></td>
			...
			<div class="modal-body" id="already_setup">
				<form action="admin/setup_tution_fee_sub" method="post">
					...
					<div class="form-group" style="margin-top:10px;">
					   ...
					   <div class="col-sm-8" >
							<input type="text" name="total_payable_fee" id="total_payable_fee" class="form-control" required />
						</div>
					</div>			
					<div class="clearfix"></div>
					<div class="form-group" style="margin-top:10px;" >
					   ...
					   <div class="col-sm-8" >
							<input type="text" name="per_semester_payable" class="form-control" required id="per_semester_payable"/>
						</div>
					</div>
	              <div class="clearfix"></div>
					<div class="form-group" style="margin-top:10px;" >

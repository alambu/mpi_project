			...
			<table class="tbl_style" width="100%" cellpadding="0" cellspacing="0"> 
               ...
               <?php if($row->admission_fee > 0):?>
				...
				<tr>
					...
					<td valign='top' style="font-size:14px;text-align:center;border-bottom:1px solid #ddd;"><?php echo ($row->semester_fee!=='0') ? number_format($row->semester_due,2): number_format($row->semester_fee,2);?></td>
				</tr>
				<tr>

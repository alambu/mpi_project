                            ...
                            <table class="table table-striped table-bordered" cellspacing="0" width="100%">
									...
									?>
                                        <tr>
                                            ...
                                            <td><a href="main/download_file/<?php echo $row->file_name?>"><span class="label label-danger">Download</span></a></td>
                                            <td><a href="main/sylabus_details/<?php echo $row->id?>"><span class="label label-danger">View</span></a></td>
                                        </tr>
										<?php endforeach;?>
                                </tbody>
                            </table>

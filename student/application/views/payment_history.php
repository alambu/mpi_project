                    ...
                    <div class="col-padded"><!-- inner custom column -->
                    	...
                    	<div class="row gutter"><!-- row -->
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                    <table class="table table-bordered">
														...
														<tr>
														  ...
														  <td><?php echo $info->total_payable_fee?></td>
														</tr>
														
														
														<tr>
														  <th>Per Semester fee</th>
														  <td><?php echo $info->per_semester_payable?></td>
														</tr>
                            ...
                            <table class="table table-striped" cellspacing="0" width="100%"> 
                                    ...
                                    <tbody>
                                      <?php  
$query=$this->db->query("select l.voucher_no,total_bill,total_received,payment_date,remarks,s.semester_name
 from student_ledger l left join semester s on l.semester_id=s.id where l.roll_no=$roll_no")->result();
		...
		<tr>
		  ...
		  <td><?php echo number_format($row->total_bill,2);$totalsem+=$row->total_bill;?></td>
		  <td><?php echo number_format($row->total_received,2);$totalad+=$row->total_received;?></td>
	...
	endforeach;
		...
		<tr style="background:#ddd;">
		  ...
		  <td>=</td>
		  <td></td>
		  <td><?php echo number_format($totalad,2);?></td>
		</tr>
		<tr>
		 <td colspan='6'></td>

...
<head>
	...
	<link rel="stylesheet" media="screen,projection" type="text/css" href="../reports/jquery-ui.css" />
...
$mot=0;
$query=$this->db->query("select l.voucher_no,dept_id,session,total_bill,total_received,payment_date,remarks,s.semester_name
 from student_ledger l left join semester s on l.semester_id=s.id where l.roll_no='$roll' and l.session='$session_id' and dept_id='$dept_id'")->result();
...
<h4><b>Name:</b> &nbsp;<?php echo urldecode($this->uri->segment(4))?> <b> &nbsp;&nbsp;Roll No:</b> <?php echo $roll?> <b> &nbsp;&nbsp;Dept:</b> <?php echo $this->lib->detpName($dept_id)->dept_name?>&nbsp;&nbsp;<b>Session:</b> <?php echo $this->lib->sessName($session_id)->title?></h4>
<table cellspacing="0">
<thead>
<tr>
<th width="20">Nr.</th>

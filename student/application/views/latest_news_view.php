...
$news=$this->db->where($where)->order_by('id','DESC')->limit(1)->get('notices')->row();
?>
            ...
            <div class="row no-gutter"><!-- row -->
                ...
                <div class="col-lg-9 col-md-9 col-lg-push-3 col-md-push-3"><!-- doc body wrapper -->
                    ...
                    <div class="row">
                                ...
                                <h1 class="page-title mb-30"><?php echo $news->title?></h1>
                                </div>	
                            </div>
                    	...
                    	<div class="row gutter"><!-- row -->
                            ...
                            <embed src="uploads/notices/<?php echo $news->notice_file;?>" width="100%" height="600"

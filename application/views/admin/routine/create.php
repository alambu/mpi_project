                                  ...
                                  <form id="fromvalid" action="admin/sylabus_routine_calander_sub" class="" method="post" enctype="multipart/form-data">
                                      <div class="form-group ">
                                          <label class="">Title</label>
                                              <input class="form-control" name="title" placeholder="Routine Title" type="text" data-bv-notempty="true" data-bv-notempty-message="Routine Title Required">
                                      </div>
                                    <div class="form-group">
                                          <label>Routine File</label>
                                          <input type="file" name="file_name" data-bv-notempty="true" data-bv-notempty-message="Routine File is required">
									...
									<div class="checkbox">
									  ...
									  <input type="hidden" name="file_status" value="2"/>
                                          <br>
                                      <div class="form-group">

...
if($roll_no==""):
 ...
 from student_ledger l inner join semester s on l.semester_id=s.id  where date(l.payment_date) between '$fdate' and '$tdate'")->result();
  ...
  $query=$this->db->query("select l.voucher_no,l.total_bill,l.roll_no,semester_due,others_fee,re_exam_fee,total_received,payment_date,remarks,s.semester_name

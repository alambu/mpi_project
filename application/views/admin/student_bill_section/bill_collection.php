                ...
                success:function(data){	
					if(data==1){
						...
						document.getElementById("semester_fee").value="0";
						 ...
						 document.getElementById('add_fee').value=<?php echo ($info->semester_due=='') ? '0' : $info->semester_due;?>;
					...
					else if(data==0)
					{
						document.getElementById("semester_fee").value=<?php echo $info->per_semester_payable?>;
						 ...
						 document.getElementById('add_fee').value=<?php echo ($info->semester_due=='') ? $info->per_semester_payable+$info->admission_fee : $info->per_semester_payable+$info->semester_due?>;
					}
			...
			function net_total()
			{
				...
				<div class="padding-zero col-md-12">		
                      <div class="form-group p-left0 col-sm-4">
						...
						<div class="form-group p-left0 col-sm-4">
								...
								<input type="text" name="re_exam_fee" id="re_exam_fee" class="form-control"  onkeyup="return calc()"  required />
						</div>
				   <div class="form-group p-left0 col-sm-4">
               ...
               <div class="padding-zero col-md-12">					
				  	...
				  	<div class="form-group p-left0 col-sm-4">
							...
							<input type="hidden" name="add_fee" id="add_fee"/>
			          </div>
					 <div class="form-group p-left0 col-sm-4">

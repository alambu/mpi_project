           ...
           <li class="sub-menu">
			...
			<?php endif; if($role=='accounts' || $role=='admin'):?>
				  ...
				  <li class="sub-menu">
                      ...
                      <ul class="sub">
                       <li><a  href="admin/all_expenses">Expense Category</a></li>
                       <li><a  href="admin/daily_expense" target="_blank">Daily Expense</a></li>
					   <li><a  href="admin/all_debit_vouchers" target="_blank">All Debit Vouchers</a></li>
					   <li><a  href="admin/daily_expense_reports" target="_blank">Daily Expense Reports</a></li>
                      </ul>
                  </li>
				   <li class="sub-menu">
                      <a href="javascript:void(0);">

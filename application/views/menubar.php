                    ...
                    <ul id="drop-down-left" class="k-dropdown-menu">
                        ...
                        <li>
                            <a href="javascript:void(0)" title="">Departments</a>
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="department/get_department/Architecture">Architecture Engineering</a></li>
                                    ...
                                    <li><a href="department/get_department/Textile">Textile Engineering</a></li>
                        ...
                        <li>
                               ...
                               <ul class="sub-menu">
                                    ...
                                    <li><a href="department/dept_teachers/Architecture">Architecture Engineering</a></li>
                        ...
                        <li>
                            <a href="javascript:void(0)" title="">Results</a>
                                <ul class="sub-menu">
                                    <li><a href="student/mpi" target="_blank">Institute Result</a></li>
                       ...
                       <li>
						...
						<li>
                            <a href="student/mpi" title="" target="_blank">Login</a>
                        </li>
                    </ul>
